...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for regular practice and matches",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, improve technique, and compete in swim meets",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "mia@mergington.edu"]
    },
    "Art Studio": {
        "description": "Experiment with painting, drawing, and mixed media art projects",
